...
class sequentialGlow {
    ...
    changeBackgroundColorSequentially(delay, fromClass, toClass, initialDelay) {
        ...
        const changeColor = () => {
            if (index < this.elements.length) {
                ...
                index++;
                this.animationTimeout = setTimeout(changeColor, delay);
            } else {
        ...
        const stopSequentialChange = () => {
            clearTimeout(this.animationTimeout); // Clear the animation timeout
    ...
    startAnimation(sequenceArray, delay = 2000, fromClass, toClass, initialDelay = 0) {
        this.elements = sequenceArray;
        return this.changeBackgroundColorSequentially(delay, fromClass, toClass, initialDelay);
    }
