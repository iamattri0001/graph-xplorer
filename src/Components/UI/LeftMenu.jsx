            ...
            <div
                ...
                <div className=' text-wedgewood-50 flex flex-col items-center justify-center gap-y-5'>
                    ...
                    <div className='flex items-center justify-center gap-x-4 bg-wedgewood-900 w-fit px-5 py-3 rounded-md'>
                        <button title='undo' className='text-3xl inline text-wedgewood-50 cursor-pointer hover:scale-110 transition-all hover:text-wedgewood-400' onClick={() => undoActions(setNodes, setEdges, getHistory)}>
                            <ImUndo2 />
                        </button>

                        <button title='redo' className='text-3xl inline text-wedgewood-50 cursor-pointer hover:scale-110 transition-all hover:text-wedgewood-400' onClick={() => redoActions(setNodes, setEdges, getDeletedHistory)}>
                            <ImRedo2 />
                        </button>
                    </div>
                </div>
