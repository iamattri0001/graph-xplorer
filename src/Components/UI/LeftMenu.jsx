...
const LeftMenu = ({ setNodeSize, nodeSize }) => {
  const {
    nodes,
    edges,
    setNodes,
        ...
        <div className=" text-wedgewood-50 flex flex-col items-center justify-center gap-y-5">
          ...
          >
            <input
              ...
              className="px-2 max-w-[160px] py-1 rounded-sm bg-transparent border-b-[1.5px] placeholder:text-gray-400 text-center placeholder:text-sm  border-wedgewood-600 focus:placeholder: outline-none focus:border-wedgewood-300"
              autoComplete="off"
            />
          ...
          <form className="flex items-center justify-center gap-y-2 flex-col bg-wedgewood-900 w-full px-5 py-3 rounded-md">
            <div className="flex items-center flex-col justify-center gap-x-3">
              <div className="flex items-center justify-center gap-x-2">
                <input
                  ...
                  id="edge-source"
                  placeholder="Source"
                  className="px-2 py-1 rounded-sm w-[60px] placeholder:text-sm bg-transparent border-b-[1.5px] border-wedgewood-600 placeholder:text-gray-400  outline-none focus:border-wedgewood-400"
                  autoComplete="off"
                ...
                <input
                  ...
                  className="px-2 py-1 rounded-sm w-[85px] placeholder:text-sm bg-transparent border-b-[1.5px] border-wedgewood-600 placeholder:text-gray-400  outline-none focus:border-wedgewood-400"
                  autoComplete="off"
                  onKeyDown={handleKeyDown}
                  ref={destInputRef}
                />
              ...
              <input
                ...
                className="px-2 py-1 rounded-sm w-[130px] placeholder:text-sm bg-transparent border-b-[1.5px] border-wedgewood-600 placeholder:text-gray-400  outline-none focus:border-wedgewood-400"
                autoComplete="off"
                onKeyDown={handleKeyDown}
                ref={wtInputRef}
              />
