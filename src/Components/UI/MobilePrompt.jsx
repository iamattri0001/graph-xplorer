        ...
        <div className='bg-wedgewood-950 h-screen flex items-center flex-col justify-center gap-y-5'>
            <h1 className='text-4xl text-center'>
                <a href="https://github.com/iamattri0001/graph-xplorer" target='_blank' rel='noreferrer' >
                    <div className='flex text-wedgewood-50 items-center justify-center gap-x-2 cursor-pointer'> <PiGraphDuotone className='hover:scale-125 transition-all text-wedgewood-300' /> <span className='title-font'>Graph Xplorer</span> </div>
                </a>
            </h1>
